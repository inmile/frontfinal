...
const HomeProductos = () => {
  ...
  useEffect(() =>{
    ...
    const cargarProductos = async () => {
      const response = await crud.GET(`/api/producto/lista/${idCategoria}`);
        ...
        <Sidebar/>
            ...
            <div className='p-12'>
              <Link
                ...
                className='bg-green-500 w-full p-3 text-black uppercase font-bold mt-4 text-center rounded-lg'
              >Crear Producto</Link>
            </div>
