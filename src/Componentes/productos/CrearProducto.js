      ...
      <div className='md:flex md:min-h-screen'>
        ...
        <form 
            ...
            >
              <div className='my-5'>
                ...
                <input
                 ...
                 value={nombre}
                  onChange={onChange}
                />
                <label className='uppercase text-white block text-xl font-bold' >descripción</label>
                <input
                  type="text"
                  id="descripcion"
                  name="descripcion"
              ...
              <label className='uppercase text-white block text-xl font-bold' >Imagen</label>
                <input
                  type="text"
                  id="imagen"
                  name="imagen"
