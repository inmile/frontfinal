            ...
            <div className='md:flex md:min-h-screen'>
                ...
                <main className='flex-1'>
                    ...
                    <div className='mt-10 flex justify-center'>
                        ...
                        >
                            <div className='my-5'>
                                <label className='uppercase text-white block text-xl font-bold'>Nombre de la Categoría</label>
                                <input
                                    type="text"
                                    id="nombre"
                                    name="nombre"
                                ...
                                <label className='uppercase text-white block text-xl font-bold'>Imágen  de la Categoría</label>
                                <input
                                    type="text"
                                    id="imagen"
                                    name="imagen"
